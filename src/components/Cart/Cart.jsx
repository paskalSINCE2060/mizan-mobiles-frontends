  ...
  return (
    <>
            ...
            {cartItems.length > 0 ? (
              <>
                ...
                <div className="cart-items-cart-actions">
                  <button className="cart-items-clear-cart" onClick={handleClearCartClick}>
                    Clear Cart
                  </button>
                  <button 
      ...
      <ConfirmationModal
        ...
        title="Clear Cart"
        message={`Are you sure you want to remove all ${cartItems.length} item${cartItems.length > 1 ? 's' : ''} from your cart? This action cannot be undone.`}
