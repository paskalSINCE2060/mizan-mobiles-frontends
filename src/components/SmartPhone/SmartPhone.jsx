...
const SmartPhone = () => {
  return (
    ...
    <div className="smart-phone-card">
        <img src="phone1.jpg" alt="Smartphone 1" className="smart-phone-image"/>
    ...
    <div className="smart-phone-card">
        <img src="phone2.jpg" alt="Smartphone 2" className="smart-phone-image"/>
    ...
    <div className="smart-phone-card">
        <img src="phone3.jpg" alt="Smartphone 3" className="smart-phone-image"/>
    ...
    <div className="smart-phone-card">
        <img src="phone4.jpg" alt="Smartphone 4" className="smart-phone-image"/>
